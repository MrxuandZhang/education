...
<div class="wrapper wrapper-content">
    <div class="form-content">
        <form id="form" class="form-horizontal">
            <input name="uid" value="${news.uid}" hidden/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4 radio i-checks" style="margin-left: 15px;">
                    <input type="radio" name="isNew" value="1"  ${news.isNew == 1 ? 'checked' :''}/>推荐
                    <input type="radio" name="isNew" value="0" ${news.isNew == 0 ? 'checked' :''}/>不推荐
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <textarea rows="20" cols="80" name="content">${news.content}</textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4 layui-input-inline">
                    <input type="text" class="laydate-icon form-control layui-input" id="create_Time"
                           name="createTime" value="value="<fmt:formatDate value="${news.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"">
                </div>
            </div>
            ...
            <div class="form-group fixed">
                <div class="col-sm-10" style="margin-left: 460px;">
                    <input class="btn btn-primary" type="submit"
                           data-url="${ctx}/news/update"
                           value="确定"/>
                    <input class="btn btn-primary" type="submit"
                           data-url="${ctx}/news/updateDraft"
                           value="保存草稿"/>
